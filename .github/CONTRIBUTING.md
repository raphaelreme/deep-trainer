...
```bash
git clone git@github.com:raphaelreme/deep-trainer.git  # OR https://github.com/raphaelreme/deep-trainer.git
cd deep-trainer
```
...
uv run pytest
# OR
uv run pytest --cov --cov-branch  # To see test coverage
```
